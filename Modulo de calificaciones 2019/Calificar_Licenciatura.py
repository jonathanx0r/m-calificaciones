...
def califica():
	...
	escribe_en_excel(calificaciones,nombre,tipos_examen)
...
def escribe_en_excel(datos_alumnos,nombre,tipos_examen):
	...
	for elemento in datos_a_imp:
		...
		j=0
		k=0
		nombre_xls=nombre+"_evaluado_examen_"+elemento+".xls"
